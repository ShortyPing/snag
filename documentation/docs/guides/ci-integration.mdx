...
Compiling snag in every job costs a minute or two even with the cache. To pull a
prebuilt binary instead, resolve the URL from the release manifest:
...
[revision.json](../reference/revision-file.mdx) for the full schema.
